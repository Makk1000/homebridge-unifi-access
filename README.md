...
- **Full HomeKit support for the UniFi Access ecosystem.** All generally available UniFi Access hub devices are supported, including the UniFi Access Gate Hub. Intercom devices like the UniFi Access G3 Intercom and G3 Reader are also supported with native HomeKit doorbell accessories and automation accelerators.
